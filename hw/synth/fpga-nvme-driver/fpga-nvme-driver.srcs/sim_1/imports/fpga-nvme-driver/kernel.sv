module kernel(
  ...
  logic push_write_cmd;
  logic push_read_cmd;
  logic [31:0] nvme_addr;
  logic [31:0] fpga_addr;
  logic [31:0] nlb;
  ...
  csr csr_i(
    ...
    .do_write(do_write),
    .do_read(do_read),
    .push_write_cmd(push_write_cmd),
    .push_read_cmd(push_read_cmd),
    .nvme_addr(nvme_addr),
    .fpga_addr(fpga_addr),
    .nlb(nlb),
